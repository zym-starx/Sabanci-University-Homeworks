...
class Sailor
{
	public:
		...
		Sailor(vector<Sailor> &sailorvector);
...
class Reservation
{
	public:
		...
		Reservation(vector<Reservation> & resvector);

		void Reservationprint(const vector<Reservation> & resvector);
